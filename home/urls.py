...
urlpatterns = [	
    ...
    path('get-account/',local_views.obtener_usuarios,name='get_users'),
    path('get-X-rays',local_views.obtener_rayos_x,name='Only_x_rays'),
	path('User-account/', local_views.profile, name='profile'),
    path('edit-profile/',local_views.edit_profile, name='editar'),
	path('Register/', RegisterPage.as_view(success_url='../'),name='Register' ),
