...
function ModRadiografia({ fechaSeleccionada }) {
          ...
          <Card key={radiografia._id} style={{ width: '18rem', margin: '1rem' }}>
            <Card.Body>
              ...
              <ListGroup variant="flush">
                ...
                {/* boton */}
                 <Link to={`/HoraModificada/?id=${radiografia._id}&examen=radiografias`} className="btn btn-primary">
                 Modificar
               </Link>
